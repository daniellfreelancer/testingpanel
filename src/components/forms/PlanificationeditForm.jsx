...
export default function PlanificationeditForm({idPlanner}) {
...
// eslint-disable-next-line
    ...
    async function handleEditPlaning(){
        ...
        axios.patch(`https://whale-app-qsx89.ondigitalocean.app/planing/update/${idPlanner}`, planificationObj)
        .then(response => {
    ...
    const fetchData = async () => {
        try {
          ...
          setEvaluationIndicators(response.data.evaluationIndicators)
            ...
            <div className="bg-white rounded shadow py-2">
                ...
                <div className="mt-10 px-7">
                    ...
                    <div className='mt-4' >
                            ...
                            <textarea value={content} onChange={(e)=> setContent(e.target.value) }   className="  text-gray-800 font-medium w-full min-h-[5rem] p-3 mt-4 border border-gray-300 rounded outline-none focus:bg-gray-50" />
                        </div>
                </div>
                ...
                <div className="flex flex-col flex-wrap items-center justify-center w-full px-7 pb-4 lg:flex-row lg:justify-end md:justify-end gap-x-4 gap-y-4">
                    ...
                    <button onClick={handleEditPlaning} className="bg-indigo-700 rounded hover:bg-indigo-600 transform duration-300 ease-in-out text-sm font-medium px-6 py-2 text-white lg:max-w-[110px] w-full ">
                        Actualizar
                    </button>
                </div>
