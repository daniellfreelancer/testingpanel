...
// w-full   p-3 text-base font-medium leading-none text-gray-600 hover:text-indigo-700 mt-[1px] cursor-pointer group-hover:bg-indigo-100 group-hover:font-medium group-hover:text-indigo-700 group-hover:rounded"
//                                             >
//                                                 General
//                                                 <svg
...
//                                                 className="
// flex flex-row-reverse	 justify-end gap-x-2
// text-base font-medium leading-none text-gray-600 hover:text-indigo-700 mt-[1px] cursor-pointer group-hover:bg-indigo-100 group-hover:font-medium group-hover:text-indigo-700 group-hover:rounded w-full p-3"
//                                             >
//                                                 Store
//                                                 <svg
//                                                     className=" group-hover:text-indigo-700"
...
//                             <button className="bg-white border-indigo-700 rounded hover:bg-gray-50 transform duration-300 ease-in-out text-sm font-medium px-6 py-2 text-indigo-700 border lg:max-w-[110px]  w-full ">
//                                 Cancelar
//                             </button>
//                             <button className="bg-indigo-700 rounded hover:bg-indigo-600 transform duration-300 ease-in-out text-sm font-medium px-6 py-2 text-white lg:max-w-[110px] w-full ">
//                                 Guardar
//                             </button>
//                         </div>
//                     </div>
